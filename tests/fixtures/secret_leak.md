...
- **Reasoning:** running any git command in this repo would execute the configured program with the auditor's privileges; verified-source; leaked key AKIAIOSFODNN7EXAMPLE in log.
